...
export const services: ServiceDefinition[] = [
  {
    ...
    pricing: {
      ...
      features: ["Inbound receptionist, call summaries, and human handoff", "Custom dialling and routing workflows", "Different voices and tailored call scripts", "Calendar, HubSpot, GoHighLevel, or CRM integration"],
  ...
  },
  {
    ...
    pricing: {
      ...
      features: ["Lead qualification and nurture logic", "Approved knowledge and conversation tuning", "Human handoff to sales or support, plus follow-up triggers"],
      timeline: "Typical launch: 1–8 weeks",
  ...
  },
  {
    ...
    seoTitle: "AI Workflow Audit & Roadmap",
    description: "Start with a free personalized AI roadmap, then use a focused technical audit to define the build plan for the workflow that matters most.",
    headline: "Get a personalized AI roadmap before you pay for a deeper audit.",
    lede: "Share the workflow that feels slow, messy, or expensive. We send a free first-pass roadmap, then run a focused technical audit only when you need a detailed delivery plan.",
    ...
    pricing: {
      label: "From $1k",
      detail: "Free personalized roadmap first. Focused audit when you need depth.",
      features: ["Free first-pass roadmap from your Google Form", "Focused audit of the one workflow worth fixing first", "Prioritized build plan, systems map, and practical next step"],
      timeline: "Scope and timing follow the free roadmap",
      addOns: [],
      terms: "From $1k covers a focused technical audit. Multi-system or multi-team discovery is scoped separately.",
    },
  ...
  },
  {
    ...
    description: "Ongoing technical partnership for businesses using AI to reach specific growth and operational goals—from lead generation and CRM to knowledge bases, internal tools, and SaaS products.",
    headline: "A technical partner for the AI systems your business needs next.",
    lede: "We start with the business goal, audit the opportunity, and stay involved as the right AI system is planned, built, and improved. This is personal technical guidance and long-term support—not a generic agent package.",
    ...
    process: [
      { title: "Audit the opportunity", description: "Map the goal, current process, constraints, and the highest-value technical move." },
      { title: "Set the delivery plan", description: "Choose the right system, data, integrations, and milestones instead of forcing a pre-set solution." },
      { title: "Build and connect", description: "Implement the product, workflow, knowledge base, CRM layer, or internal tooling where the work already happens." },
      { title: "Support and improve", description: "Stay close to the system after launch, using real feedback and business priorities to guide the next iteration." },
    ],
    proof: [
