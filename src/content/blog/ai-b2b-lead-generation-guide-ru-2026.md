...
- [Apify Agent Skills](https://github.com/apify/agent-skills) — запускает и настраивает сбор через актёры Apify.
- [Agent Reach](https://github.com/Panniantong/Agent-Reach) — помогает дополнить карточки данными из открытых источников, если их нет на карте.
...
- [Agent Reach](https://github.com/Panniantong/Agent-Reach) — поиск и чтение публичных сайтов и профилей компании.
- [Apify Agent Skills](https://github.com/apify/agent-skills) — подключение дополнительных источников данных через Apify.
...
- [Marketing Skills](https://github.com/coreyhaines31/marketingskills) — используйте навыки **Copywriting** и **Copy Editing**, чтобы сформулировать оффер и проверить текст перед отправкой.
- [Humanizer](https://github.com/blader/humanizer) — помогает убрать шаблонные AI-обороты из черновика. Он не заменяет проверку фактов и тона человеком.
...
- [Marketing Skills](https://github.com/coreyhaines31/marketingskills) — навык **RevOps** помогает определить обязательные поля, статусы и передачу лида между маркетингом и продажами.
- [Apify Agent Skills](https://github.com/apify/agent-skills) — пригодится, если нужно регулярно обновлять собранную базу перед загрузкой в CRM.
